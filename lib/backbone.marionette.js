...
Marionette.View = Backbone.View.extend({
  ...
  // MN: I would rather speak to the model itself, instead of the attributes only
  //     The idea of mixing template helpers with the attributes instead of the model is also fairly awkward and makes iterations really difficult
  ...
  serializeData: function(){
    ...
    if (this.model) {
      ...
      // we top it up with the context - if available
...
Marionette.CollectionView = Marionette.View.extend({
  ...
  initialEvents: function(){
    if (this.collection){
      ...
      // MN: due to the way that modified backbone collection works, we don't need to render whole collection 
      //     each time that collection is "reset". now collection emmits add's and removes. 
...
_.extend(Marionette.Module.prototype, Backbone.Events, {
  ...
  start: function(options){
    ...
    // MN: I turned around the order of initialization 
    // MN: now first the parent module is initialized, and then it proceeds 
    // MN: with initalization of the sub-modules
...
_.extend(Marionette.TemplateCache.prototype, {
  ...
  loadTemplate: function(templateId){
    /* MN: we just dont need that crap.
     *     templates are loaded through JST
     *     so I just return id as a template */
    return( templateId );
